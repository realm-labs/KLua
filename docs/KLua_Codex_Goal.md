...
- Runtime errors preserve structured source-name, line, and Lua call-frame metadata from VM bytecode positions through core execution results and API runtime exceptions, and host exceptions can survive as runtime error causes.
