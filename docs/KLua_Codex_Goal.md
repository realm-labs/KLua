...
| --- | --- | --- | --- |
| 1 | M20 next conformance campaign selection | Select one explicit remaining subsystem gap. Name the relevant Lua 5.5 source functions and affected KLua entry points, define a bounded case matrix, and update the gap snapshot after verification. | One coherent conformance commit; do not mix unrelated probes. |
