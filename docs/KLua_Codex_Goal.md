...
- String pattern support covers literals, dot wildcard, anchors, Lua character classes, bracket classes/ranges, and bracketed percent classes for fixed-width matches.
