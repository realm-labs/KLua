...
- Initial `klua-debug` source-line breakpoint manager for setting, replacing, clearing, listing, and enabled-hit lookup by source ID and line, plus public Lua stack-frame and local-variable debugger views with stable value summaries.
