...
- Broader standard library implementation, including protected calls (`pcall`, `xpcall`), table edge cases, string pattern/format, math edge cases, and utf8 coverage.
- Coroutine runtime.
