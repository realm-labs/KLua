...
- AST model, compiler, internal bytecode, prototype model with source IDs, valid breakpoint line metadata, local variable debug ranges, upvalue name metadata, function definition line ranges, constant pool, and disassembler.
