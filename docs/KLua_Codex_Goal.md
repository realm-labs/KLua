...
- Initial `klua-dap` typed session surface for initialize requests, advertised debugger capabilities, `setBreakpoints` source breakpoint replacement, `configurationDone`, and pause/continue/step controls backed by the debug controller.
