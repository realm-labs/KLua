...
- Runtime errors preserve structured source-name, line, Lua call-frame metadata, and readable traceback strings from VM bytecode positions through core execution results and API runtime exceptions, and host exceptions can survive as runtime error causes.
